...
/**
 * 
 * Or for reference have a look here: <a href="https://api.cloudcontrol.com/doc/#DeploymentAddonREAD">https://api.cloudcontrol.com/doc/#DeploymentAddonREAD</a>
 * 
 * @author Denis Neuling (denisneuling@gmail.com)
 */
@Method(HttpMethod.GET)
@Path("/app/${app}/deployment/${dep}/addon/")
public class ListAddonRequest extends Request<ListAddonResponse> {
	private static final long serialVersionUID = -8352470460542868457L;
