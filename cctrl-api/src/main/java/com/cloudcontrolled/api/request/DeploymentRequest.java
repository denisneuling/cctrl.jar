...
/**
 * 
 * Or for reference have a look here: <a href="https://api.cloudcontrol.com/doc/#DeploymentREAD">https://api.cloudcontrol.com/doc/#DeploymentREAD</a>
 * 
 * @author Denis Neuling (denisneuling@gmail.com)
 */
@Method(HttpMethod.GET)
@Path("/app/${app}/deployment/${dep}/")
public class DeploymentRequest extends Request<DeploymentResponse> {
	private static final long serialVersionUID = 8434094930940253920L;
